                                ...
                                <tr>
                                    <td style="text-align: center;">
                                        <a href="#"><img class="w320" width="311" height="83"
                                                         src="http://internetretailing.net/files/2014/02/surfdome_logo.jpg"
                                                         alt="Surfdome"></a>
                                    </td>
                                </tr>
                            </table>
                                            ...
                                            <table style="margin: 0 auto;" cellspacing="0" cellpadding="0"
                                                ...
                                                <tr>
                                                    <td style="text-align:left; color: #6f6f6f;">
                                                        <br>
                                                        Hello,<br><br>
                                                        A password reset has been requested. If you did not request this change
                                                        simply ignore this email <a href="http://dev.idro.org.uk/~dylan.heywood/surfdomeCOPY/password-reset/">Reset password</a>. <br><br>
