...
$qry = "UPDATE PasswordReset SET Active=0 WHERE Email = ?";
$stmt = $con->prepare($qry);
$stmt->bind_param('s',$email);
$stmt->execute();
$qry = "INSERT INTO PasswordReset VALUES (null,?,?,1)";
$stmt = $con->prepare($qry);
            ...
            <table style=\"margin:0 auto;\" cellspacing=\"0\" cellpadding=\"0\" width=\"100%\">
              <tr>
                <td style=\"text-align: center;\">
                  <a href=\"#\"><img class=\"w320\" width=\"311\" height=\"83\" src=\"https://static-surfdome.global.ssl.fastly.net/assets/ui/logos/surfdome-logo-no-tagline-fb2d388707df9684316ad8aac52640ee.png\" alt=\"company logo\" ></a>
                </td>
              </tr>
            </table>
              ...
              <tr>
                <td style=\"background-color:#3bcdb0;\">
                  ...
                  <table cellspacing=\"0\" cellpadding=\"0\" width=\"100%\">
                    <tr>
                      <td>
                        <img src=\"http://www.holidaysbywyndham.com.au/wps/wcm/connect/6a03ca46-be89-49a4-b7af-b4910b43c39e/Surf+HBW+Offer+Landing+Page3.jpg?MOD=AJPERES&CACHEID=6a03ca46-be89-49a4-b7af-b4910b43c39e\" style=\"max-width:100%; display:block;\">
                      </td>
                    </tr>
                  </table>
              ...
              <tr>
                ...
                <table style=\"margin: 0 auto;\" cellspacing=\"0\" cellpadding=\"0\" class=\"force-width-80\">
                  <tr>
                    ...
                    <br>
                    Hello,<br><br>
                    You have requested a password reset. If you did not update your settings, please just ignore this email. <br><br>
                    ...
                    <br>
                      <div><!--[if mso]>
                        <v:rect xmlns:v=\"urn:schemas-microsoft-com:vml\" xmlns:w=\"urn:schemas-microsoft-com:office:word\" href=\"http://\" style=\"height:45px;v-text-anchor:middle;width:220px;\" stroke=\"f\" fillcolor=\"#f5774e\">
                          ...
                          <center>
                        <![endif]-->
                            <a href=\"http://dev.idro.org.uk/~dylan.heywood/surfdomeCOPY/change-password/".$rand."\"
                          style=\"background-color:#f5774e;color:#ffffff;display:inline-block;font-family:'Source Sans Pro', Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;line-height:45px;text-align:center;text-decoration:none;width:220px;-webkit-text-size-adjust:none;\">Change password</a>
                            <!--[if mso]>
                          </center>
                        </v:rect>
                      <![endif]--></div>
...
$headers .= 'From: donotreply@surfdome.com' . "\r\n";
$headers .= 'Cc: tech@surfdome.com' . "\r\n";

mail($email,$subject,$message,$headers);
echo $email."<br>".$subject."<br>".$message."<br>".$headers;